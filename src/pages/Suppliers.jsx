...
function Suppliers() {
  ...
  useEffect(() => {
    ...
    const fetchSuppliers = async () => {
      try {
        const response = await doGet("https://muyvj4lsu6.execute-api.us-east-1.amazonaws.com/Prod/supplier/getAll");
  ...
  const handleDelete = (supplierId) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        doDelete(`https://muyvj4lsu6.execute-api.us-east-1.amazonaws.com/Prod/supplier/delete/${supplierId}`)
          .then(() => {
            Swal.fire(
              'Eliminado!',
